...
it("should use/preserve accessor form for import object and namespaces", function () {
	...
	expectSourceToMatch(source, `${regexEscape('const ww = (__rspack_require(')}\\d+${regexEscape(')/* .obj1.bing.bang */.obj1.bing.bang);')}`);
	expectSourceToMatch(source, `${regexEscape('const xx = (__rspack_require(')}\\d+${regexEscape(')/* .obj1.pip.pop */.obj1.pip.pop)();')}`);
	expectSourceToMatch(source, `${regexEscape('const yy = (__rspack_require(')}\\d+${regexEscape(')/* .m_2.m_1.obj1.tip.top */.a.a.obj1.tip.top)();')}`);
