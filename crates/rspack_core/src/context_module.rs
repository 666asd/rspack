...
impl ContextModule {
  ...
  fn get_sync_weak_source(
    ...
    formatdoc! {r#"
      ...
      function __rspack_module_context(req) {{
        var id = __rspack_module_context_resolve(req);
      ...
      function __rspack_module_context_resolve(req) {{
      ...
      __rspack_module_context.keys = {keys};
      __rspack_module_context.resolve = __rspack_module_context_resolve;
      __rspack_module_context.id = {id};
      {module}.exports = __rspack_module_context;
      "#,
      module = runtime_template.render_module_argument(ModuleArgument::Module),
      map = json_stringify_pretty(&map),
      fake_map_init_statement = self.get_fake_map_init_statement(&fake_map),
